...
private WebTestClient manageClient;
    ...
    public ChenXiaoruTest() {
        this.manageClient = WebTestClient.bindToServer()
                .baseUrl("http://114.215.198.238:4560")
                .defaultHeader(HttpHeaders.CONTENT_TYPE, "application/json;charset=UTF-8")
                .build();
    }
...
//        JSONAssert.assertEquals(expectedResponse, new String(responseString, "UTF-8"), false);
    ...
    public void advertiseTest36() throws Exception {
        ...
        String expectedResponse = "{\"errno\":0,\"data\":{\"total\":7,\"pages\":1,\"pageSize\":10,\"page\":1,\"list\":[" +
                "{\"id\":202,\"link\":null,\"imagePath\":\"http://47.52.88.176/file/images/201610/1475991949547324589.jpg\"," +
                "\"content\":null,\"segId\":102,\"state\":4,\"weight\":\"1\",\"beDefault\":false,\"beginDate\":\"2020-12-15\"," +
                "\"endDate\":\"2021-10-10\",\"repeat\":true}," +
                "{\"id\":424,\"link\":null,\"imagePath\":\"http://47.52.88.176/file/images/201610/1475992167803037996.jpg\"," +
                "\"content\":null,\"segId\":102,\"state\":4,\"weight\":\"4\",\"beDefault\":false,\"beginDate\":\"2020-12-15\"," +
                "\"endDate\":\"2021-10-10\",\"repeat\":false}," +
                "{\"id\":425,\"link\":null,\"imagePath\":\"http://47.52.88.176/file/images/201610/1476498085799000890.jpg\"," +
                "\"content\":null,\"segId\":102,\"state\":4,\"weight\":\"5\",\"beDefault\":false,\"beginDate\":\"2020-12-15\"," +
                "\"endDate\":\"2021-10-10\",\"repeat\":true}," +
                ...
                "\"content\":null,\"segId\":102,\"state\":4,\"weight\":\"2\",\"beDefault\":false,\"beginDate\":\"2020-12-15\"," +
                "\"endDate\":\"2021-10-10\",\"repeat\":false}," +
                "{\"id\":428,\"link\":null,\"imagePath\":\"http://47.52.88.176/file/images/201611/1479267660182463918.jpg\"," +
                "\"content\":null,\"segId\":102,\"state\":4,\"weight\":\"3\",\"beDefault\":false,\"beginDate\":\"2020-12-15\"," +
                "\"endDate\":\"2021-10-10\",\"repeat\":false}," +
...
//        String token = this.adminLogin("13088admin", "123456");
//        byte[] responseString = manageClient.get().uri("/shops/{did}/timesegments/{id}/advertisement/?" +
//                "beginDate=2020-01-10&endDate=2020-12-12&page=1&pageSize=3", 0, 102)
//                .header("authorization",token)
//                .exchange()
//                .expectStatus().isOk()
//                .expectBody()
...
//    }
    ...
    public void advertiseTest43() throws Exception{
        ...
        String expectedResponse = "{\"errno\":0,\"data\":" +
                ...
                "\"segId\":102,\"state\":0,\"weight\":\"5\",\"beDefault\":false," +
    ...
    public void advertiseTest46() throws Exception{
        String token = this.adminLogin("13088admin", "123456");
        byte[] responseString =  manageClient.post().uri("/shops/{did}/timesegments/{tid}/advertisement/{id}", 0, 102,430)
                .header("authorization", token)
                .exchange()
                .expectStatus().isCreated()
                .expectBody()
        ...
        String expectedResponse = "{\"errno\":0,\"data\":{\"id\":430,\"link\":null," +
                ...
                "\"content\":null,\"segId\":102,\"state\":4,\"weight\":\"5\",\"beDefault\":false," +
